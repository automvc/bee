...
public class BeeIllegalBusinessException extends BeeException {
	...
	public BeeIllegalBusinessException(String message) {
		super(message);
	}

	public BeeIllegalBusinessException(String message, Throwable cause) {
		super(message, cause);
	}

	public BeeIllegalBusinessException(Throwable cause) {
		super(cause);
	}
